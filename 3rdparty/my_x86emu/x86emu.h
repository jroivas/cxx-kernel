...
#if 0
extern uint64_t my__udivdi3(uint64_t num, uint64_t den);
extern uint64_t my__umoddi3(uint64_t num, uint64_t den);
extern int64_t my__divdi3(int64_t num, int64_t den);
extern int64_t my__moddi3(int64_t num, int64_t den);
#endif
